...
{
    public function repository(): OrderCouponRepository
    {
        return app(OrderCouponRepository::class);
    }
    ...
    public function getOrFail(int|string $id): OrderCoupon
    {
        return $this->repository()->findOrFail($id);
    }

    public function findBy(array $criteria): ?OrderCoupon
    {
